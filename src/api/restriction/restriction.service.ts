...
export class RestrictionService {
	...
	public async create(dto: CreateRestrictionRequest) {
		...
		if (activeRestriction) throw new ConflictException('User already has an active restriction')
	...
	public async cancel(userId: string) {
		...
		if (!restriction) throw new NotFoundException('No active restriction found for this user')
