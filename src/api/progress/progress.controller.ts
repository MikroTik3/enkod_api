...
export class ProgressController {
	...
	public async getCourseProgress(@Authorized() user: User, @Param('courseId') courseId: string) {
	...
	@Put()
	@HttpCode(HttpStatus.OK)
	public async create(@Authorized() user: User, @Body() dto: CreateProgressRequest) {
